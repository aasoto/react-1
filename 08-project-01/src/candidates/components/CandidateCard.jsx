...
export const CandidateCard = ({
  ...
  return (
    <div className="relative col-span-1 h-[450px] rounded-lg shadow-lg bg-white">
      ...
      <Link to={`/candidate/${ id }`} className="absolute bottom-4 left-4 text-rose-600 hover:text-rose-700 font-semibold hover:font-bold hover:underline transition duration-200">
        Meet
      </Link>
    </div>
  )
